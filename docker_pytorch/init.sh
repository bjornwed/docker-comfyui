...
# Reinstall Transformers with this command line "python.exe -m pip install transformers"
...
exec python main.py --listen 0.0.0.0 --preview-method auto --output-directory $COMFYUI_OUTPUT 
